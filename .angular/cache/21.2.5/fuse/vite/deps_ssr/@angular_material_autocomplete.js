...
} from "./chunk-F7554BV2.js";
import "./chunk-SR6WKK6J.js";
import {
  MAT_FORM_FIELD
} from "./chunk-ERH3KYFG.js";
import "./chunk-G4ZEEJ3M.js";
import "./chunk-BNEM3XBS.js";
import "./chunk-PJ3BB4Q2.js";
import "./chunk-5ERLMRE4.js";
...
import {
  NG_VALUE_ACCESSOR
} from "./chunk-FU7RX2GI.js";
import {
  ActiveDescendantKeyManager,
  addAriaReferencedId,
  removeAriaReferencedId
} from "./chunk-DCDVY356.js";
...
var MatAutocompleteTrigger = class _MatAutocompleteTrigger {
  ...
  get panelClosingActions() {
    return (0, import_rxjs.merge)(this.optionSelections, this.autocomplete._keyManager.tabOut.pipe((0, import_operators.filter)(() => this._overlayAttached)), this._closeKeyEventStream, this._getOutsideClickStream(), this._overlayRef ? this._overlayRef.detachments().pipe((0, import_operators.filter)(() => this._overlayAttached)) : (0, import_rxjs.of)()).pipe((0, import_operators.map)((event) => event instanceof MatOptionSelectionChange ? event : null));
  }
  ...
  _subscribeToClosingActions() {
    ...
    const optionChanges = this.autocomplete.options?.changes.pipe((0, import_operators.tap)(() => this._positionStrategy.reapplyLastPosition()), (0, import_operators.delay)(0)) ?? (0, import_rxjs.of)();
    return (0, import_rxjs.merge)(initialRender, optionChanges).pipe((0, import_operators.switchMap)(() => this._zone.run(() => {
